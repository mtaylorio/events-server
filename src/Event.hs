...
data Event
  = EventPublish !UUID !UUID !EventData
  | EventSubscribe !UUID
...
instance FromJSON Event where
  parseJSON (Object o) = do
    ...
    case eventType of
      Just "publish" -> EventPublish <$> o .: "topic" <*> o .: "id" <*> o .: "data"
...
instance ToJSON Event where
  toJSON (EventPublish topic event data') = object
    ["type" .= ("publish" :: Text), "topic" .= topic, "event" .= event, "data" .= data']
